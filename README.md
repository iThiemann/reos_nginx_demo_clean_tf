...
You don’t want long YAML or bash scripts sitting inside your .tf files.
...
Terraform simply loads it via file("files/cloud-init.yaml"), keeping your .tf logic clean.
